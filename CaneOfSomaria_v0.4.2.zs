...
`/SKomaria platform notes

store the position of the platform.

allow link to move as lomng asCanWalk (latform area)

If Link tries to walk off the platform , stop him unless there is a ledge to walk omtop

if the platform is about to move in a way that Link would wall off, pull him with it. 
